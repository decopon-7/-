...
**キャラクターデザイン担当**: ジェンさん
本仕様書は最終デザインそのものではなく、方向性を伝えるための制作ブリーフ(コンセプト・性格・カラーパレット・造形/モーションルール)。ジェンさんにはこの内容をもとに、たねちゃん・みどり先生の正式なキャラクター原案(三面図・表情差分)を起こしてもらう。

**方向性確認用ラフスケッチ(Artifact)**: https://claude.ai/artifact/B6wsKXRmHXBB8ZHrTqq3LH
(たねちゃん・みどり先生の正面イラストのラフ、カラーパレット、スケール比較を1枚のキャンバスにまとめたもの。あくまで方向性を伝えるための簡易ラフであり、最終デザインはジェンさんの手による原案を正とする)
...
- 本仕様書をジェンさんに共有し、たねちゃん・みどり先生の正式なキャラクター原案(三面図・表情差分)を起こしてもらう
- 各シリーズの台本([scripts/](../scripts/))にある演出メモを、本仕様書のモーションルールと突き合わせて統一する
- モーションガイドライン(まばたき間隔、口パクパターン等)は、ジェンさんのキャラクター原案が確定した後にアニメーション用ガイドとして別途追補する
- ジェンさんの原案が上がり次第、本仕様書のカラーパレット・造形ルールを確定版に更新する
